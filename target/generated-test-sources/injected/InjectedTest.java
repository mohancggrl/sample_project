...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"io.jenkins.plugins:com.devops.com:1.0-SNAPSHOT");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","/tmp/sample");
    parameters.put("artifactId","com.devops.com");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","/tmp/sample/target/classes");
    parameters.put("testOutputDirectory","/tmp/sample/target/test-classes");
